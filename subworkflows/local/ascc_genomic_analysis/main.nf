...
include { GET_KMERS_PROFILE                             } from '../get_kmers_profile/main'
include { EXTRACT_TIARA_HITS                            } from '../extract_tiara_hits/main'
include { EXTRACT_NT_BLAST                              } from '../extract_nt_blast/main'
include { ORGANELLAR_BLAST as PLASTID_ORGANELLAR_BLAST  } from '../organellar_blast/main'
include { ORGANELLAR_BLAST as MITO_ORGANELLAR_BLAST     } from '../organellar_blast/main'
include { PACBIO_BARCODE_CHECK                          } from '../pacbio_barcode_check/main'
include { RUN_READ_COVERAGE                             } from '../run_read_coverage/main'
include { RUN_VECSCREEN                                 } from '../run_vecscreen/main'
include { RUN_NT_KRAKEN                                 } from '../run_nt_kraken/main'
include { RUN_FCSGX                                     } from '../run_fcsgx/main'
include { RUN_FCSADAPTOR                                } from '../run_fcsadaptor/main'
include { RUN_DIAMOND as NR_DIAMOND                     } from '../run_diamond/main'
include { RUN_DIAMOND as UP_DIAMOND                     } from '../run_diamond/main'
...
workflow ASCC_GENOMIC_ANALYSIS {
    ...
    vecscreen_database_path      // channel: tuple(val(meta), path(db))
