...
def process_blast_results(blast_tsv, taxdump_data, output_csv, column_name_prefix):
    ...
    with open(blast_tsv, "r") as blast_file, open(
        ...
        fieldnames = [
            "scaff",
            f"{column_name_prefix}blast_accession",
            f"{column_name_prefix}blast_score",
            f"{column_name_prefix}blast_taxid",
            f"{column_name_prefix}blast_species",
            f"{column_name_prefix}blast_genus",
            f"{column_name_prefix}blast_family",
            f"{column_name_prefix}blast_order",
            f"{column_name_prefix}blast_class",
            f"{column_name_prefix}blast_phylum",
            f"{column_name_prefix}blast_kingdom",
            f"{column_name_prefix}blast_superkingdom",
            f"{column_name_prefix}blast_no_rank",
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        prog="Get Lineage for Top BLAST Hits",
